...
urlpatterns = [
    ...
    path("create_account/<int:appointment_id>/", views.admin_panel_faq.create_account, name="create_account"),
   ...
   # Phone Service Schedule
    ...
    path("reschedule_appointment/<str:date_encoded>/", views.reschedule_appointment, name="reschedule_appointment"),
